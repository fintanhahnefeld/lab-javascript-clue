...
function pickMystery(){
    let newObject = {};
    newObject.suspect = selectRandom(suspectsArray);
    newObject.room = selectRandom(roomsArray);
    newObject.weapon = selectRandom(weaponsArray);
...
let solutionMessage = revealMystery(mysterySolution);
